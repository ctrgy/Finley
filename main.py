...
with st.expander("Store Memories: Capture insights, learnings, and wins"):
    ...
    st.write("- Celebrate team wins on forecasts, projects, or milestones.")
...
# Input form
st.markdown('<h2 class="section-title">Add your commentary or question</h2>', unsafe_allow_html=True)
...
if submitted:
    if message.strip():
        ...
        st.error("Please enter something before saving.")
